...
pub(in crate::libpcsc) const SCARD_SCOPE_USER: DWORD = 0x0000;
...
pub(in crate::libpcsc) const SCARD_SCOPE_TERMINAL: DWORD = 0x0001;

pub(in crate::libpcsc) const SCARD_SCOPE_SYSTEM: DWORD = 0x0002;

/// Services are on a remote machine.
///
/// Does nothing in pcsclite or Windows or macos.
pub(in crate::libpcsc) const SCARD_SCOPE_GLOBAL: DWORD = 0x0003;
