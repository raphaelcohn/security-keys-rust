...
impl Display for CreateChannelUnexpectedError
{
	#[inline(always)]
...
impl error::Error for CreateChannelUnexpectedError
{
}
...
impl CreateChannelUnexpectedError
{
	...
	pub(in crate::ifdhandler::driver) fn parse(error: RESPONSECODE) -> Self
	{
		...
		match error
		{
			IFD_ICC_PRESENT => IccPresent,
			
			IFD_ICC_NOT_PRESENT => IccNotPresent,
