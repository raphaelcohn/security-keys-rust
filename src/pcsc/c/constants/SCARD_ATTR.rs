...
#[cfg_attr(not(target_os = "windows"), allow(dead_code))] pub(in crate::pcsc) const SCARD_ATTR_DEVICE_FRIENDLY_NAME_W: DWORD = SCARD_ATTR_VALUE(SCARD_CLASS_SYSTEM, 0x0005);
#[cfg_attr(not(target_os = "windows"), allow(dead_code))] pub(in crate::pcsc) const SCARD_ATTR_DEVICE_SYSTEM_NAME_W: DWORD = SCARD_ATTR_VALUE(SCARD_CLASS_SYSTEM, 0x0006);
#[allow(dead_code)] const SCARD_ATTR_DEVICE_FRIENDLY_NAME: DWORD = SCARD_ATTR_DEVICE_FRIENDLY_NAME_A;
#[allow(dead_code)] const SCARD_ATTR_DEVICE_SYSTEM_NAME: DWORD = SCARD_ATTR_DEVICE_SYSTEM_NAME_A;
