		...
		(
			...
			(
				Self
				{
					...
					associated_input_terminal: entity_body.optional_non_zero_u8_unadjusted(adjusted_index::<7>()),
					...
					common: TerminalEntityCommon
					{
						...
						description: Version3AudioDynamicStringDescriptorIdentifier::parse(entity_body, adjusted_index::<19>(), Version3EntityDescriptorParseError::AudioDynamicStringDescriptorIdentifierIsOutOfRange)?,
					},
