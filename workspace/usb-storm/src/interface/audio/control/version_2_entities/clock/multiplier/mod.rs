...
use crate::interface::audio::control::entities::{ClockEntity, DescribedEntity, Version2Entity, MultiplierClockEntity};
...
include!("Version2MultiplierClockEntityParseError.rs");
