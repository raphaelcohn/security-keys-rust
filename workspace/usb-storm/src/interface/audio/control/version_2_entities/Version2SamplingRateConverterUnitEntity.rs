	...
	fn parse(entity_body: &[u8], string_finder: &StringFinder) -> Result<DeadOrAlive<Self>, Self::ParseError>
	{
		...
		(
			...
			(
				Self
				{
					source_cluster_identifier: entity_body.optional_non_zero_u8_unadjusted(adjusted_index::<4>()).map(UnitOrTerminalEntityIdentifier::new),
					
					source_input_clock_entity: entity_body.optional_non_zero_u8_unadjusted(adjusted_index::<5>()),
					
					source_output_clock_entity: entity_body.optional_non_zero_u8_unadjusted(adjusted_index::<6>()),
