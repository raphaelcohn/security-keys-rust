...
pub enum Version2ExtensionUnitEntityParseError
{
	#[allow(missing_docs)]
	PIsTooLarge,
...
impl Display for Version2ExtensionUnitEntityParseError
{
	#[inline(always)]
...
impl error::Error for Version2ExtensionUnitEntityParseError
{
	#[inline(always)]
