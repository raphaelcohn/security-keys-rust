...
#[inline(always)]
fn parse_controls_by_channel_number<Controls, E: error::Error, ControlsError: error::Error>(entity_body: &[u8], controls_parser: impl Fn(u32) -> Result<Controls, ControlsError>, controls_length_error: E, memory_allocation_error: impl FnOnce(TryReserveError) -> E, controls_parser_error: impl FnOnce(ControlsError, u8) -> E) -> Result<ChannelControlsByChannelNumber<Controls>, E>
{
