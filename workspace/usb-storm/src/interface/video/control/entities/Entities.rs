...
impl<E: Entity> Entities<E>
{
	...
	#[inline(always)]
	fn push_anonymous(&mut self, entity: E) -> Result<(), EntityDescriptorParseError>
	{
		self.anonymous.try_push(entity).map_err(EntityDescriptorParseError::OutOfMemoryPushingAnonymousEntityDescriptor)
	}
	
	#[inline(always)]
	fn push_identified(&mut self, entity: E, entity_identifier: NonZeroU8) -> Result<(), EntityDescriptorParseError>
	{
