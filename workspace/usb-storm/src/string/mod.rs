...
use crate::control_transfers::descriptors::{GetDescriptorError, MaximumStandardUsbDescriptorLength};
...
include!("get_localized_string_utf16_little_endian.rs");
include!("GetLanguagesError.rs");
include!("GetLocalizedStringError.rs");
include!("GetLocalizedUtf16LittleEndianStringError.rs");
