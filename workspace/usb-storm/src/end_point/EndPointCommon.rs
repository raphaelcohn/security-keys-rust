...
impl EndPointCommon
{
	...
	#[inline(always)]
	pub(super) fn parse(end_point_descriptor: &libusb_endpoint_descriptor, string_finder: &StringFinder, bLength: u8, transfer_type: &mut Either<Option<NonZeroU8>, (Direction, DirectionalTransferType)>) -> Result<DeadOrAlive<Self>, EndPointParseError>
	{
		...
		let descriptors = Self::parse_descriptors(string_finder, end_point_descriptor, transfer_type, maximum_packet_size).map_err(CouldNotParseEndPointAdditionalDescriptor)?;
	...
	#[inline(always)]
	fn parse_descriptors<'a>(string_finder: &StringFinder, end_point_descriptor: &libusb_endpoint_descriptor, transfer_type: &'a mut Either<Option<NonZeroU8>, (Direction, DirectionalTransferType)>, maximum_packet_size: u11) -> Result<DeadOrAlive<Vec<Descriptor<EndPointExtraDescriptor>>>, DescriptorParseError<EndPointExtraDescriptorParseError>>
	{
