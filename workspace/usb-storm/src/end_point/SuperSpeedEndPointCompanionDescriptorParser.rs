...
struct SuperSpeedEndPointCompanionDescriptorParser<'a>
{
...
impl<'a> SuperSpeedEndPointCompanionDescriptorParser<'a>
{
	#[inline(always)]
	fn parse(&mut self, remaining_bytes: &[u8], bLength: u8) -> Result<Option<DeadOrAlive<(EndPointExtraDescriptor, usize)>>, SuperSpeedEndPointCompanionDescriptorParseError>
	{
		use SuperSpeedEndPointCompanionDescriptorParseError::*;
		use DirectionalTransferType::*;
		
		const BLength: u8 = SuperSpeedEndPointCompanionDescriptorParser::SuperSpeedCompanionBLength;
	...
	#[inline(always)]
	fn parse_super_speed_plus_isochronous_end_point_companion_descriptor(remaining_bytes: &[u8]) -> Result<(u32, usize), SuperSpeedPlusIsochronousEndPointCompanionDescriptorParseError>
	{
		use SuperSpeedPlusIsochronousEndPointCompanionDescriptorParseError::*;
