...
impl TryFrom<u16> for UsbVersion
{
	type Error = UsbVersionParseError;
	...
	/// This is for a little-endian `u16`.
	#[inline(always)]
	fn from(binary_coded_decimal: u16) -> Result<Self, Self::Error>
	{
		use self::UsbVersionParseError::*;
		...
		#[inline(always)]
		fn parse_digit<const index: u16>(binary_coded_decimal: u16, error: impl FnOnce(u8) -> UsbVersionParseError) -> Result<u4, UsbVersionParseError>
		{
