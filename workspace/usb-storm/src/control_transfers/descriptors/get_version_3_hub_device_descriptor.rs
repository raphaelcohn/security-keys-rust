...
#[inline(always)]
pub(crate) fn get_version_3_hub_device_descriptor(device_handle: NonNull<libusb_device_handle>, buffer: &mut [MaybeUninit<u8>; MaximumStandardUsbDescriptorLength]) -> Result<DeadOrAlive<Option<&[u8]>>, GetStandardUsbDescriptorError>
{
	const descriptor_type: u8 = LIBUSB_DT_SUPERSPEED_HUB;
