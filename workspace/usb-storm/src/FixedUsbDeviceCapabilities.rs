...
pub(crate) struct FixedUsbDeviceCapabilities
{
...
{
	#[inline(always)]
	pub(crate) const fn new(composite_maximum_number_of_slots: Option<NonZeroU8>) -> FixedUsbDeviceCapabilities
	{
		Self
		{
	...
	#[inline(always)]
	pub(crate) fn TAG_IFD_SLOTS_NUMBER(&self, maximum_slot_index: u8) -> NonZeroU8
	{
