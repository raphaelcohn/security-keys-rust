...
pub enum ReconnectionUnavailableOrCommunicationError
{
...
impl Display for ReconnectionUnavailableOrCommunicationError
{
	#[inline(always)]
...
impl error::Error for ReconnectionUnavailableOrCommunicationError
{
	#[inline(always)]
...
impl From<UnavailableOrCommunicationError> for ReconnectionUnavailableOrCommunicationError
{
	#[inline(always)]
	fn from(cause: UnavailableOrCommunicationError) -> Self
	{
		ReconnectionUnavailableOrCommunicationError::UnavailableOrCommunication(cause)
	}
}
