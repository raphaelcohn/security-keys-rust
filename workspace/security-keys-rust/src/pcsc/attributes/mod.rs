...
use super::c::constants::SCARD_ATTR_DEVICE_FRIENDLY_NAME_A;
#[cfg(target_os = "windows")] use super::c::constants::SCARD_ATTR_DEVICE_FRIENDLY_NAME_W;
use super::c::constants::SCARD_ATTR_DEVICE_IN_USE;
use super::c::constants::SCARD_ATTR_DEVICE_SYSTEM_NAME_A;
#[cfg(target_os = "windows")] use super::c::constants::SCARD_ATTR_DEVICE_SYSTEM_NAME_W;
